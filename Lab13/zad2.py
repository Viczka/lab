class book():
    ...
    def kupuj(self, cena= input("Ile kosztuje książka po przecenie?:")):
       return "W końcu kupię swoją ulubioną książke {}. Po przecenie ona kosztuje tylko ".format(self.tytul) + cena + " pln.."
    def wydanie(self):
